 ...
 *
 * @author leizhi
 * @link https://support.huaweicloud.com/accessg-marketplace/zh-cn_topic_0093493995.html
 */
@Component
public class HuaweiReport {
    ...
    /** ak */
    private static final String AK = "BVY6PXOU7MLRPXOZBTMJ";

    /** sk */
    private static final String SK = "OvHEoiL2sBCD4RoUHwMOFxow62gXO2q6sjGprF7H";

    /** 合作伙伴（ISV）的ID（华为分配）*/
    private static final String PARTNER_ID = "hw16238094";

    private String mktUrl = "https://mkt.myhuaweicloud.com/v1.0/" + PARTNER_ID + "/billing/bill-mgr/push-usage-data";

    public Map<String, Object> queryUsage() {
        Map<String, Object> usageRecords = new HashMap<>();

        // 封装第一条业务计量数据(根据实际情况，将此段写在循环中处理)
        Map<String, Object> usageRecordData1 = new HashMap<>();
        // 产品实例ID
